...
export interface V2DutchOrderReactorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "execute"
      | "executeBatch"
...
export interface V2DutchOrderReactor extends BaseContract {
  connect(runner?: ContractRunner | null): V2DutchOrderReactor;
  waitForDeployment(): Promise<this>;

  interface: V2DutchOrderReactorInterface;
