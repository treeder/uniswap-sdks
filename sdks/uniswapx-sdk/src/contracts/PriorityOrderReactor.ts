...
export interface PriorityOrderReactorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "execute"
      | "executeBatch"
...
export interface PriorityOrderReactor extends BaseContract {
  connect(runner?: ContractRunner | null): PriorityOrderReactor;
  waitForDeployment(): Promise<this>;

  interface: PriorityOrderReactorInterface;
