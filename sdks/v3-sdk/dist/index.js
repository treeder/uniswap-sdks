...
import { CurrencyAmount, Price as Price2 } from "@treeder/uniswap-sdk-core";
...
var JSBI = class _JSBI extends Array {
  ...
  static DataViewGetBigUint64(i, _, t = false) {
    const [e, n] = t ? [4, 0] : [0, 4], g = i.getUint32(_ + e, t), s = i.getUint32(_ + n, t), o = new _JSBI(3, false);
  ...
  static __fromDouble(i) {
    ...
    n.__setDigit(e - 1, r);
    for (let _2 = e - 2; 0 <= _2; _2--) 0 < a ? (a -= 30, r = g >>> 2, g = g << 30 | s >>> 2, s <<= 30) : r = 0, n.__setDigit(_2, r);
    return n.__trim();
  }
    ...
    if (0 == (_ & _ - 1)) {
      ...
      do {
        ...
        for (; ; ) {
          ...
          if (g = i.charCodeAt(n), 30 < r2 + o) break;
        }
  ...
  static __toStringBasePowerOfTwo(_, i) {
    ...
    const n = e, g = i - 1, s = _.__digit(t - 1), o = _JSBI.__clz30(s);
    ...
    for (let e2 = 0; e2 < t - 1; e2++) {
      ...
      const s2 = n - d;
      for (u = i2 >>> s2, d = 30 - s2; d >= n; ) r[a--] = _JSBI.__kConversionChars[u & g], u >>>= n, d -= n;
    }
    const h = (u | s << d) & g;
    for (r[a--] = _JSBI.__kConversionChars[h], u = s >>> n - d; 0 !== u; ) r[a--] = _JSBI.__kConversionChars[u & g], u >>>= n;
  ...
  static __toStringGeneric(_, i, t) {
    ...
    const n = 30 * e - _JSBI.__clz30(_.__digit(e - 1)), g = _JSBI.__kMaxBitsPerChar[i], s = g - 1;
    let o = n * _JSBI.__kBitsPerCharTableMultiplier;
    o += s - 1, o = 0 | o / s;
  ...
  static __compareToDouble(i, _) {
    ...
    const g = i.length;
    let s = i.__digit(g - 1);
    const o = _JSBI.__clz30(s), l = 30 * g - o, r = n + 1;
  ...
  static __multiplyAccumulate(_, t, e, n) {
    ...
    for (let r, a = 0; a < _.length; a++, n++) {
      r = e.__digit(n);
      const i = _.__digit(a), t2 = 32767 & i, u = i >>> 15, d = _JSBI.__imul(t2, g), h = _JSBI.__imul(t2, s), m = _JSBI.__imul(u, g), b = _JSBI.__imul(u, s);
  ...
  static __internalMultiplyAdd(_, t, e, g, s) {
    let o = e, l = 0;
    for (let n = 0; n < g; n++) {
      const i = _.__digit(n), e2 = _JSBI.__imul(32767 & i, t), g2 = _JSBI.__imul(i >>> 15, t), a = e2 + ((32767 & g2) << 15) + l + o;
  ...
  __inplaceMultiplyAdd(i, _, t) {
    ...
    let g = 0, s = _;
    for (let o = 0; o < t; o++) {
      const i2 = this.__digit(o), _2 = 32767 & i2, t2 = i2 >>> 15, l = _JSBI.__imul(_2, e), r = _JSBI.__imul(_2, n), a = _JSBI.__imul(t2, e), u = _JSBI.__imul(t2, n);
      let d = s + l + g;
  ...
  static __absoluteDivLarge(i, _, t, e) {
    ...
    for (let r2, h = s; 0 <= h; h--) {
      ...
      if (i2 !== u) {
        ...
        for (; _JSBI.__imul(r2, n2) >>> 0 > (e3 << 16 | s2) >>> 0 && (r2--, e3 += u, !(32767 < e3)); ) ;
      }
  ...
  static __leftShiftByAbsolute(_, i) {
    ...
    const e = 0 | t / 30, n = t % 30, g = _.length, s = 0 !== n && 0 != _.__digit(g - 1) >>> 30 - n, o = g + e + (s ? 1 : 0), l = new _JSBI(o, _.sign);
    if (0 === n) {
      let t2 = 0;
...
import { ChainId as ChainId2, computeZksyncCreate2Address } from "@treeder/uniswap-sdk-core";
...
import { MaxUint256 } from "@treeder/uniswap-sdk-core";
...
import { MaxUint256 as MaxUint2563 } from "@treeder/uniswap-sdk-core";
import invariant3 from "tiny-invariant";

// src/utils/mostSignificantBit.ts
import { MaxUint256 as MaxUint2562 } from "@treeder/uniswap-sdk-core";
...
import { sqrt } from "@treeder/uniswap-sdk-core";
...
import { Price } from "@treeder/uniswap-sdk-core";
...
import { MaxUint256 as MaxUint2564, Percent, CurrencyAmount as CurrencyAmount2 } from "@treeder/uniswap-sdk-core";
...
import { Price as Price4 } from "@treeder/uniswap-sdk-core";
var Route = class {
  pools;
  tokenPath;
  input;
...
import { Fraction, Percent as Percent2, Price as Price5, sortedInsert, CurrencyAmount as CurrencyAmount3, TradeType } from "@treeder/uniswap-sdk-core";
...
import { validateAndParseAddress } from "@treeder/uniswap-sdk-core";
...
import { TradeType as TradeType2 } from "@treeder/uniswap-sdk-core";
...
// src/staker.ts
import { validateAndParseAddress as validateAndParseAddress3 } from "@treeder/uniswap-sdk-core";
...
import { CurrencyAmount as CurrencyAmount6, TradeType as TradeType3, validateAndParseAddress as validateAndParseAddress4 } from "@treeder/uniswap-sdk-core";
